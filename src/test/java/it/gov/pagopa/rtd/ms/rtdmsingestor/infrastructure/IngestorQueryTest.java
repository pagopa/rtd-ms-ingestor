...
class IngestorQueryTest {
    ...
    final EPIEntity paymentInstrumentItem1 = EPIEntity.builder().id("1").hashPan("testHashPan")
            .hashPanChildren(
                    List.of("c3141e7c87d0bf7faac1ea3c79b2312279303b87781eedbb47ec8892f63df3e9"))
    ...
    final EPIEntity paymentInstrumentItem2 = EPIEntity.builder().id("2")
            ...
            .state("READY").apps(List.of("IDPAY")).network("").issuer("")
            .insertAt(LocalDateTime.now()).updatedAt(LocalDateTime.now())
            .insertUser("enrolled_payment_instrument").updateUser("enrolled_payment_instrument")
            .version(1).build();
    ...
    final EPIEntity paymentInstrumentItem3 = EPIEntity.builder().id("3")
            ...
            .state("REVOKED").apps(List.of("IDPAY")).network("").issuer("")
            .insertAt(LocalDateTime.now()).updatedAt(LocalDateTime.now())
            .insertUser("enrolled_payment_instrument").updateUser("enrolled_payment_instrument")
            .version(1).build();
    ...
    void testFindHashpanFunction() throws IOException {
        ...
        assertEquals(false,
                repository
                        .findItemByHash(
                                "7858580aef0faef76c2d6839f84ec383947783966c99cf6afad446a54ddc0e94")
                        .isPresent());
        assertEquals(false,
                repository
                        .findItemByHash(
                                "ee4bac9851e9f4325b008bd6c92af29d0d45dd6c6511dd286c5995825695feec")
                        .isPresent());
    }
