...
import it.gov.pagopa.rtd.ms.rtdmsingestor.service.TransactionVerifier;
...
@Slf4j
public class RtdEventProcessorHandler implements EventProcessorHandler {

    private final StreamBridge sb;
    private final IngestorRepository repository;

    private long numNotEnrolledCards = 0;
    private long numCorrectTrx = 0;
    private long numTotalTrx = 0;

    public RtdEventProcessorHandler(StreamBridge sb, IngestorRepository repository) {
        this.sb = sb;
    ...
    public long getNumNotEnrolledCards() {
        return numNotEnrolledCards;
    }

    public long getNumCorrectTrx() {
        return numCorrectTrx;
    }

    public long getNumTotalTrx() {
        return numTotalTrx;
    }
}
